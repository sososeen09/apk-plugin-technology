...
public class HookLoadedApkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hook_loaded_apk);
        ...
        public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            holder.btnLoad.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        PluginManager.getInstance().loadPlugin(pluginItem.pluginPath);
